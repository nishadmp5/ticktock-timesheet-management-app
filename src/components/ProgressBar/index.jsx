...
const ProgressBar = ({ totalTrackedHours, totalHours }) => {
  ...
  return (
    <div className="max-w-47 w-full h-1.5 bg-[#E5E7EB] rounded-sm relative group ">
      ...
      >
        <div className="w-22.5 h-10.5 pb-1 absolute right-0 translate-x-1/2  bottom-full group-hover:opacity-100 opacity-0 transition-opacity pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-[81%] bg-white shadow-[0_2px_8px_1px_rgba(0,0,0,0.1)] rounded-md flex justify-center items-center ">
